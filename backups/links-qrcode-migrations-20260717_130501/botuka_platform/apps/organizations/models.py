...
class Empresa(UUIDModel):
    ...
    qr_ativo = models.BooleanField(default=True, db_column='platform_empresa_qr_ativo')
...
class EmpresaLink(UUIDModel):
    ...
    identificador_externo = models.CharField(max_length=120, blank=True, db_column='platform_empresa_link_identificador_externo')
