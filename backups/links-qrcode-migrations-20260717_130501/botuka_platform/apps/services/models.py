...
class Servico(UUIDModel):
    ...
    qr_ativo = models.BooleanField(default=True, db_column='services_servico_qr_ativo')
...
class ServicoLink(UUIDModel):
    ...
    identificador_externo = models.CharField(max_length=120, blank=True, db_column='services_servico_link_identificador_externo')
